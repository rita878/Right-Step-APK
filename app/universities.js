...
import {
  ...
  FlatList, ActivityIndicator, Alert, Modal, Linking, ScrollView
} from 'react-native';
import axios from 'axios';
import useAuthRedirect from '../hooks/useRequireAuth'; // ✅ Corrected path
...
export default function Universities() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>🎓 University Explorer</Text>
      ...
      <View style={styles.toggleContainer}>
        ...
        >
          <Text style={[styles.toggleText, activeList === 'public' && styles.activeText]}>Public</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.toggleButton, activeList === 'private' && styles.activeButton]}
          onPress={() => fetchUniversities('private')}
        >
          <Text style={[styles.toggleText, activeList === 'private' && styles.activeText]}>Private</Text>
        </TouchableOpacity>
      </View>
